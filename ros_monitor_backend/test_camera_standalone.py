...
class StandaloneCameraTester:
    ...
    def __init__(self, topic: str, save_dir: str = "test_images"):
        self.topic = topic
...
def main():
    """主函数"""
    logger.info("启动独立的相机测试器...")
    
    # 初始化ROS节点
    rospy.init_node('standalone_camera_tester', anonymous=True)
    ...
    for topic in camera_topics:
        tester = StandaloneCameraTester(topic)
